    ...
    <div className="min-h-[calc(100vh-64px)] bg-muted/20 py-12">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto mb-12 text-center">
          <h1 className="text-4xl font-heading font-bold text-primary mb-4">Marriage Readiness Training</h1>
          <p className="text-lg text-muted-foreground">
            Equip yourself with the knowledge and skills for a successful, lifelong partnership. 
            Our modules are designed to help you navigate the complexities of marriage with wisdom and grace.
          </p>
        </div>
                ...
                <Card className={`h-full border-none shadow-lg transition-all hover:shadow-xl ${isCompleted ? 'bg-primary/5 border border-primary/10' : ''}`}>
                  ...
                  <CardContent className="space-y-6">
                    <div className="flex items-center gap-4 text-sm text-muted-foreground">
                      ...
                      <span className="flex items-center gap-1"><BookOpen className="w-4 h-4" /> {module.quiz.length} Quiz Questions</span>
                    </div>
        ...
        <div className="mt-16 p-8 bg-secondary/10 rounded-2xl border border-secondary/20 text-center max-w-3xl mx-auto">
          <h2 className="text-2xl font-heading font-bold text-secondary-foreground mb-4">Why Training Matters</h2>
          <p className="text-muted-foreground italic">
            "The best of you are those who are best to their families." 
            Investing in your relationship skills is an act of worship and a commitment to your future spouse's happiness.
          </p>
        </div>
      </div>
    </div>
