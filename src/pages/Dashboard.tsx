        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">AI-curated suggestions based on your compatibility profile.</p>
            </div>
        ...
        <div className="space-y-8">
          <Card className="border-none shadow-lg h-[calc(100vh-160px)] flex flex-col">
            <CardHeader className="border-b bg-primary/5">
              ...
              <CardDescription>Your formal guide to a successful marriage journey.</CardDescription>
            </CardHeader>
            ...
            <CardContent className="flex-1 overflow-hidden p-0">
              <ScrollArea className="h-full p-4">
                <div className="space-y-4">
                  ...
                  <div className="bg-primary/10 p-3 rounded-lg rounded-tr-none max-w-[85%] ml-auto">
            ...
            <div className="p-4 border-t">
              <form className="flex gap-2" onSubmit={(e) => e.preventDefault()}>
                <Input 
                  placeholder="Ask about matches or advice..." 
                  value={query}
